...
xh = [0;0;0;0]; Pk = 10; xhd =[]; Pd = []; Qk = 1000*eye(2); Rk = 10*eye(2);
for k = k_0:k_f
    % Simulation
    d = chol(Qk)'*randn(2,1);
    d = zeros(2,1);
...
sgtitle('Input-constrained and Soft-output-constrained MPC controlling approximated system','FontSize',11)
